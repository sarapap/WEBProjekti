...
const updateSelectedAlatyyppi = () => {
    const selectedAlatyyppi = document.getElementById('hotFoodType').value;
    hotFoodList.innerHTML = '';
    console.log('Valittu tyyppi:', selectedAlatyyppi);
    return selectedAlatyyppi;
};


document.getElementById('hotFoodType').addEventListener('change', async () => {
...
const fetchAndDisplayByTyyppiId = async (tyyppiId) => {
    try {
        ...
        const cakeList = document.getElementById('hotFoodList');
