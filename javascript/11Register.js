...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', function (event) {
            ...
            const data = {
                etunimi: document.getElementById('firstname') ? document.getElementById('firstname').value : '', // Turvallinen pääsy
                ...
                syntymapaiva: document.getElementById('syntymapaiva') ? document.getElementById('syntymapaiva').value : null,
                rooli: "admin",
                ehdot_hyvaksytty: document.querySelector('#accept-1') ? (document.querySelector('#accept-1').checked ? 1 : 0) : 0,
